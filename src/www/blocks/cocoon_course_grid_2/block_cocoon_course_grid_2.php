...
class block_cocoon_course_grid_2 extends block_base {
    ...
    public function get_content() {
        ...
        $this->content->text .= '
        <section id="our-top-courses" class="'.$ccnClassMasonry_cont.' our-courses saccn-courses-grid-block ccn-courses-grid-block-2" data-ccn-c="color_bg" data-ccn-co="bg" style="background-color: '.$this->content->color_bg.';">
          <div class="container">
            <div class="row">

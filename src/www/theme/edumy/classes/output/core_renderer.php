...
return $output;
  ...
  public function heading($text, $level = 2, $classes = null, $id = null) {
	...
	// Custom function per la stampa del titolo e descrizione blog
	 ...
	 * @return string the HTML to output.
	 */
	public function mlab_heading( $text, $level = 2, $classes = null, $id = null ) {

		$content = html_writer::start_tag( 'div', array( 'class' => 'ccnMdlHeading ' ) );
		...
		$content .= html_writer::tag(
			...
			array(
				'id' => $id,
				'class' => renderer_base::prepare_classes( $classes ) . ' blogTitle'
			)
		);
		...
		$content .= html_writer::tag(
			...
			array(
				'id' => $id,
				'class' => renderer_base::prepare_classes( $classes ) . ' blogDescription'
			)
		);

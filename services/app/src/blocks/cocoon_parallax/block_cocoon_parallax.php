 				...
 				<div class="col-lg-8 text-center">
 					<div class="divider-one ">
                        <h1 class="parallax-h1" data-ccn="title">'. format_text($this->content->title, FORMAT_HTML, array('filter' => true)) .'</h1>
 						...
 						<a data-ccn="button_text" aria-label="Vai alla pagina dei corsi" style="margin-bottom: 30px;" class="btn btn-primary" href="'. format_text($this->content->button_link, FORMAT_HTML, array('filter' => true)) .'">'. format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)) .'</a>
 					</div>
 				</div>
 			</div>
 		</div>

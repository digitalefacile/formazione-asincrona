    ...
    function get_content()
    {
        ...
        if ($data->slidesnumber > 0) {
            ...
            for ($i = 1; $i <= $data->slidesnumber; $i++) {
                ...
                if ($ccnTabBody == 'text4') {
                    $titleOfAccordion = 'Impara a usare Facilita con quattro video lezioni';
                    $inputButton = '
                    <div class="find-out-more">
                        <a href="./facilita-redirect.php" id="scopriDipiùTab"  aria-label="Scopri di più" class="text_3_tabs" >Vai al tutorial 
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="margin-left: 5px;"viewBox="0 0 24 24" fill="none">
                            <path d="M13.9 5L13.2 5.7L18.5 11.1H3V12.1H18.5L13.2 17.5L13.9 18.2L20.5 11.6L13.9 5Z" fill="#0066CC"/>
                            </svg>
                        </a>

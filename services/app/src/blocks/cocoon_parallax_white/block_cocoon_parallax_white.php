        ...
        <section >
      		<div class="container-fluid">
      			<div class="row" style="justify-content:center;">
      				<div class="parallax_white_first_div">
      					<div >
                                
      						<h3 class="parallax_white_title" data-ccn="title">'.format_text($this->content->title, FORMAT_HTML, array('filter' => true)).'</h3>

      						<p class="parallax_white_paragraph" data-ccn="subtitle">'.format_text($this->content->subtitle, FORMAT_HTML, array('filter' => true)).'</p>

      						<a data-ccn="button_text" aria-label="Accedi al sito"  target="'.$this->content->button_target.'" href="'.format_text($this->content->button_link, FORMAT_HTML, array('filter' => true)).'" class="btn btn-primary button_parallax_white">'.format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)).'</a>
      					</div>
      				</div>
      				<div class="parallax_white_second_div">
      					<div class="about_thumb_home3 text-right">
      						<img class="img-fluid" src="'.$this->content->image.'" alt="prova alt">
      					</div>
      				</div>
      			</div>
      		</div>

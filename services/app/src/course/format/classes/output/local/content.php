...
class content implements named_templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        // Aggiunge l'url dell'immagine di copertina ai dati per il template
        // TODO: fare un override nel tema
        if(!isset($context)) {
            $context = \context_course::instance($this->format->get_courseid());
        } 
        $data->coverimage = course_summary_exporter::get_course_image($this->format->get_course(), $context);
        $data->hascoverimage = !empty($data->coverimage);
